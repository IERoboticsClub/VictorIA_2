...
# NOTE: This entire file is outdated but i need it for some references
...
def calculate_average_color(cell, x, y, r):
    ...
    # 50% of the circle radius
    inner_radius = int(r * 0.25)
...
def process_each_cell_single_core_old(image_path=None, columns=7, rows=6, circle_detector=None, force_image=None,
    ...
    for row in range(rows):
        ...
        for col in range(columns):
            ...
            # extract the cell directly from picture using slicing
            cell = image[y_start:y_end, x_start:x_end]
    ...
    # save the processed board overlay for later and debugging
